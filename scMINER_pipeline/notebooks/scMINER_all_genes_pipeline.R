...
# into a single combined dataset, we skip the QC, filtration and normalisation steps.
...
# Extract and transpose: cells x genes → genes x cells (2853 x 7884)
...
# STEP 4: Run MICA in terminal (NIET in R — zware berekening!)
# mica ge -i "./MICA/MICA_all_genes_Input.txt" -o "./MICA/micaOutput" -nw 6 -nc 6

# ==============================================================================
# STEP 5: AUTOMATED DIRECTORY LOOP FOR DIRECT SILHOUETTE SCORE CALCULATION
# ==============================================================================
...
# --------------------------------------------------------------------------
# Generates an expression dotplot of the top marker genes across all clusters
print(feature_bubbleplot(input_eset   = combined.eset, 
